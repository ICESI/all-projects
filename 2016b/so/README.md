...
* Repositorio en github con código fuente y archivo README.md con las indicaciones para la configuración de CentOS7 y el despliegue de la aplicación. Incluir capturas de pantalla donde evidencie que cumple con lo solicitado (10%)
